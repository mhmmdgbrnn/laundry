                ...
                <tbody>
                    @foreach ($progres as $item)
                        <tr>
                            ...
                            <td>
                                @if ($item->status == 0)
                                    <span class="badge badge-secondary bg-info">Sudah diterima</span>
                                @elseif ($item->status == 1)
                                    <span class="badge badge-dark bg-info">Dicuci</span>
                                @elseif ($item->status == 2)
                                    <span class="badge badge-primary bg-info">Dikeringkan</span>
                                @elseif ($item->status == 3)
                                    <span class="badge badge-info bg-info">Disetrika</span>
                                @elseif ($item->status == 4)
                                    <span class="badge badge-warning bg-info">Menunggu Dibayar</span>
